    ...
    <div class="bio">
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    <h1 class="bio__htext">
                        Oliy ta’lim muassasalari bakalaviratining kirish imtihonlarida eng yuqori ball to'plagan talabalar uchun <span>prezident granti</span>
                    </h1>
                    <div class="bio__ptext">
                        Talabalar uchun prezident granti tanloviga onlayn ariza yuborish portaliga xush kelibsiz!
                    </div>
                    <a href="https://olimpiada.edu.uz/auth/one-id-callback">
                    ...
                    <div class="bio__resault">
                        <div class="bio__resault-num">
                          0
                        </div>
                        <div class="bio__resault-text">
                            Jami <br>
